...
Respond ONLY as valid JSON without backticks:
{
  ...
  "suggestions": {
    "batiment": {
      "icon": "🏢",
      "label": "ONE single simple iconic building representing this company",
    ...
    "objet": {
      "icon": "🎾",
      "label": "ONE single iconic object directly representing core activity",
      "desc": "1 short sentence - For Padelstay this would be ONLY a padel court, for a bakery ONLY a bread, etc.",
    ...
    "scene": {
      "icon": "🎬",
      "label": "ONE simple scene max 3 elements",
      "desc": "1 short sentence",
